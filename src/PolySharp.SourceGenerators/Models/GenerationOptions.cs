...
/// <param name="UseEmbeddedAttributeForGeneratedTypes">Whether to emit the <c>[Embedded]</c> attribute and apply it to generated types.</param>
...
internal sealed record GenerationOptions(
    ...
    bool UseEmbeddedAttributeForGeneratedTypes,
